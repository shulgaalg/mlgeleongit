...
<head>
	...
	<!-- test -->
	<title>Все Расходные материалы для шиномонтажа и ремонта колес</title>
	...
	<link rel='stylesheet' id='gp-font-awesome-css' href='../../fonts/font-awesome.min.css' type='text/css' media='all' />
...
<body>
	...
	<section id="step1">
		<div class="flex" id="header">
			<div class="grow m-2">
				<div id="logo" style="" class="default-logo"> <img src="../../img/logo.png" />
				</div>
				<!--! Языки. переключение и ссылки   
			...
			<div class="grow mr-4 flex justify-center">
				<div class="p-2">
				...
				<span class="telephone text-white ">
					<a  href="tel:0996699668" onClick="ga('send', 'event', 'Perezvon', 'Zvonok'); yaCounter49714474.reachGoal('step0:perezvon'); return true;">(099) 669 96 68
					</a>
				</span>
			</div>
		</div>
					...
					<div class="uk-padding-step1 uk-width-2-1@m">
						...
						<div class="moduletable">
							...
							<div class="price rounded-md">
								...
								<form method="POST" id="form" action={{route('tThanks')}} onsubmit="javascript:return validate('form','email');">
								{{csrf_field()}}
									...
									<input onclick="gtag('event', 'newsletter_submit', { 'event_category': 'form_zayvka', 'event_action': 'submit', });" class="btn bg-green-200" id="submit" type="submit" value="👉написать нам💪" />
								</form>
...
">
	...
	<div class="uk-child-width-1-2@m uk-child-width-1-2@s" style="    display: flex;    flex-wrap: wrap;">
		<divide class="divid" style="background: url(../../img/latki.jpg) no-repeat center -150px;">
				...
				<div class="uk-section uk-padding-remove">
					...
					<div class="uk-child-width-1-4@m uk-child-width-1-2@s uk-padding-large uk-grid" uk-grid="">
						...
						<div class="kakworktext">
							...
							<h3>Подбираем несколько вариантов материалов для ремонта шин на выбор</h3>
							<div class="custom"> </div>
						</div>
						<div class="kakworktext">
						...
						<div class="kakworktext">
							...
							<h3>Собираем заказ и отправляем в этот же день со своего склада по Украине - всегда все для шиномонтажа у нас в наличии!</h3>
							<div class="custom"> </div>
						</div>
					</div>
				</div>
			...
			<div class="uk-padding-tovari uk-width-1-1@m">
				<div class="uk-section uk-padding-remove">
					<div class="moduletable uk-center color-black">
						...
						<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/xnOrp3hBed4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen class="video"></iframe>
						<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/Py8uvlaObVg" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen class="video"></iframe>
						<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/5PaxpDER0Gw" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen class="video"></iframe>
					</div>
				</div>
			</div>
	</section>
...
@if(!empty($_GET['utm_campaign']))
	...
	<sectioncontact class="contact">
		...
		<p>Мы свяжемся с Вами, чтобы уточнить детали. В зависимости от индивидуальных пожеланий мы предложим несколько вариантов расходников и проконсультируем Вам по их применению.</p>
		<form method="POST" id="form5" action="/t/application.php">
	...
	<section>
		...
		<form method="POST" id="sp-quickcontact-form_popup" action="/t/application.php" onsubmit="javascript:return validate('sp-quickcontact-form_popup','email');">
			...
			<input onclick="gtag('event', 'consult_submit', { 'event_category': 'form_contacts', 'event_action': 'submit', });" class="uk-button uk-large uk-button-primary" id="submit" class="button" type="submit" value="Отправить" />
	...
	<div id="my-idpricetovari" uk-modal>
		<div class="uk-modal-dialog uk-margin-auto-vertical uk-modal-body">
			...
			<div class="moduletable">
				...
				<div id="sp_quickcontact102" class="sp_quickcontact">
					<div id="sp_qc_status2"></div>
					<form method="POST" id="form2" action="{{route('tThanks')}}" onsubmit="javascript:return validate('form2','email');">
						@if(!empty($_GET['utm_campaign']))
						<input type="hidden" name="utm_campaign" value="<?php echo $_GET['utm_campaign']; ?>" />
						@endif
						@if(!empty($_GET['utm_medium']))
						...
						<input type="hidden" name="utm_term" value="<?php echo $_GET['utm_term']; ?>" />
						@endif 
						<input class="uk-input rounded-md" type="email" name="email" id="email" placeholder="Введите Ваш E-mail*" required style="text-indent: 25px;" /> <i class="fa fa-envelope-o" aria-hidden="true" style="margin: -32px 0 0 13px; position: absolute; "></i>
						<input class="uk-input rounded-md" type="text" id="tel" name="telephone" placeholder="+38 (0__) ___-__-__" value="" required style="text-indent: 25px;" /> <i class="fa fa-mobile fa-2x" aria-hidden="true" style="margin: -36px 0 0 13px; position: absolute; "></i>
						<input onclick="gtag('event', 'newsletter_submit', { 'event_category': 'form_price', 'event_action': 'submit', });" class="uk-button uk-large uk-button-primary bg-green-200 rounded-md" id="submit" class="button" type="submit" value="Получить прайс-лист" />
					</form>
					<!-- 		<script type="text/javascript">
