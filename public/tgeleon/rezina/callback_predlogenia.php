...
<meta http-equiv="Refresh" content="2; URL=/rezina"> 
</head>
<body>
...
$utm = '';
  ...
  $queryData = http_build_query(array(
    'fields' => array(
      ...
      'TITLE' => $_POST['title'] . ' Сайт: t.geleon.ua/rezina/',
      'NAME' => $_POST['name'], 
      'ASSIGNED_BY_ID' => 1,
...
$subject  = "ПРЕДЛОЖЕНИЕ ПО РАСХОДНОМУ МАТЕРИАЛУ с t.geleon.ua/rezina/";
...
$msg .= "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;'>Заявка с t.geleon.ua/rezina</h2>\r\n";
